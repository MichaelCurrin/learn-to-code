...
- [StackEdit](https://stackedit.io/) - Edit markdown files on Github using your browser. 
    ...
    - Use:
        ...
        6. You will see your folder tree on the left. Note that files will give a data error initially while content is being pulled in. Note that `.md` extension 
        7. You may add more repos and then switch between then.
    - Help - select Table of Contents from the menu on the right.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ5NDc4NjMwN119
-->